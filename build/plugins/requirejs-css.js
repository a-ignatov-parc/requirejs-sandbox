(function (root, factory) {
	if (typeof define === 'function' && define.amd) {
		define('requirejs-css', [], factory);
	} else {
		root.requirejsSandbox || (root.requirejsSandbox = {});
		root.requirejsSandbox['plugins']['requirejs-css'] = factory();
	}
}(this, function () {
/**
...
define('plugins/requirejs-css',[],function() {
	...
	return require('plugins/requirejs-css');
}));

	if (typeof define === 'function' && define.amd) {
		require(['requirejs-css'], function(plugin) {
